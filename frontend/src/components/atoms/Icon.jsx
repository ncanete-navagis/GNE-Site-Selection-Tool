...
// Stubbing out common SVGs based on lucide-react / standard icons
const icons = {
  ...
  layers: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 12 12 17 22 12"></polyline><polyline points="2 17 12 22 22 17"></polyline></svg>,
...
export const Icon = ({ name, className = '', color = 'currentColor' }) => {
  return (
    <span className={`icon ${className}`} style={{ color, display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
      {icons[name] || null}
    </span>
  );
};
